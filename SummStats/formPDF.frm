...
Begin VB.Form formConvertToPDF 
   ...
   Begin VB.Label lblCredits 
      BackColor       =   &H00FFC0C0&
      Caption         =   "Written by Paras Chopra"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
      ...
      Left            =   120
      TabIndex        =   26
      ToolTipText     =   "http://naramcheez.paraschopra.com"
      Top             =   5640
      Width           =   2760
   End
   Begin VB.Label Label1 
      BackColor       =   &H00FFC0C0&
      Caption         =   "www.paraschopra.com"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
      ...
      Left            =   120
      TabIndex        =   25
      ToolTipText     =   "mailto:paraschopra@paraschopra.com"
      Top             =   6000
      Width           =   2655
   End
...
Const AppName = "PDFProducer"

Private Sub Form_Load()
  
  txtCreator.Text = AppName & " v" & App.Major & "." & App.Minor
  Me.Caption = txtCreator
  cmbFont.AddItem "Courier"
  cmbFont.AddItem "Times-Roman"
  cmbFont.AddItem "Arial"
  cmbFontSize.AddItem "8pt"
  cmbFontSize.AddItem "10pt"
  cmbFontSize.AddItem "12pt"
  cmbFontSize.AddItem "14pt"
  cmbFontSize.AddItem "16pt"
  cmbFontSize.AddItem "18pt"
  cmbFontSize.AddItem "20pt"
  cmbRotation.AddItem "0°"
  cmbRotation.AddItem "90°"
  cmbRotation.AddItem "180°"
  cmbRotation.AddItem "360°"
  cmbPageSize.AddItem "8.5"" x 11"""
  cmbPageSize.AddItem "8.5"" x 14"""
  cmbPageSize.AddItem "14"" x 11"""
